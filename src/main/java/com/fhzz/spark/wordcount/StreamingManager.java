...
public class StreamingManager {
	...
	private static Map<String, StreamingManager> instances = null;
	...
	private StreamingManager(String name, String checkpoint) {
	...
	public static StreamingManager getInstance(String name, String checkpoint) {
		if (instances == null) {
			instances = new HashMap<String, StreamingManager>();
		}
		StreamingManager instance = instances.get(name);
		if (instance == null) {
			instance = new StreamingManager(name, checkpoint);
